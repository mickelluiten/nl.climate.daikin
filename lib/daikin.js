   ...
   var daikin = new DaikinAC(ip_address, options, function(err) {
      ...
      // modified DaikinAC,js so that currentACControlInfo is sent iso currentACModelInfo                     
       ...
       switch (airco_mode) { 
          ...
          case "streamer":        return; // not implemented, special modes are handled in subroutine daikinSpecialModeControl
          
          case "powerful":        var amode = 3; var setpow = powerctrl;        
                                  break; // special modes are handled in subroutine daikinSpecialModeControl
          
          case "econo":           return; // not implemented, special modes are handled in subroutine daikinSpecialModeControl
