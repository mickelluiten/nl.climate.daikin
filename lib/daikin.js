...
exports.request_control = function(ip_address, epp, callback) {
	console.log('exports.request_control');	

	var target = "http://" + ip_address;
	var request = "GET";
	var parameters = epp + "aircon/get_control_info";
...
exports.request_sensor = function (ip_address, epp, callback) {
	console.log('exports.request_sensor');	
	
	var target = "http://" + ip_address;
	var request = "GET";
	var parameters = epp + "aircon/get_sensor_info";
...
exports.daikinModeControl = function(airco_mode, ip_address, epp, options, demo_mode) {
   ...
   //var options = {'logger': console.log}; // optional logger method to get debug logging      
   var daikin = new DaikinAC(ip_address, epp, options, function(err) {
      ...
      // modified DaikinAC,js so that currentACControlInfo is sent iso currentACModelInfo                     
       ...
       switch (airco_mode) { 
          case "off":             var setpow = false;
                                  ...
                                  daikin.setACControlInfo({"power":setpow, "mode":0, "targetTemperature":21, "targetHumidity":40}); //default values assigned...                              
                                  return;
          
          //case "cooling":       var amode = 3; var setpow = powerctrl; // obsolete...         
          //                      break;

          case "cool":            var amode = 3; var setpow = powerctrl; // standard for all models including Homekit
                                  break;
                                                    
          //case "heating":       var amode = 4; var setpow = powerctrl; // obsolete... 
          //                      break;

          case "heat":            var amode = 4; var setpow = powerctrl; // standard for all models including Homekit
                                  break;
          ...
          case "streamer":        return; // special modes are handled in subroutine daikinSpecialModeControl
          
          case "powerful":        return; // special modes are handled in subroutine daikinSpecialModeControl
          
          case "econo":           return; // special modes are handled in subroutine daikinSpecialModeControl
...
exports.daikinSpecialModeControl = function(airco_mode, ip_address, epp, options, advstate) {
   console.log('exports.daikinSpecialModeControl');
   
   console.log('SpecialModeState:', advstate);
   ...
   var daikin = new DaikinAC(ip_address, epp, options, function(err) {
      ...
      // modified DaikinAC,js so that currentACControlInfo is sent iso currentACModelInfo                     
       ...
       switch (airco_mode) { 
          ...
          case "streamer":        var SpecialModeState = advstate; var SpecialModeKind = 0;
                                  break;

          case "powerful":        var SpecialModeState = advstate; var SpecialModeKind = 1;
                                  break;

          case "econo":           var SpecialModeState = advstate; var SpecialModeKind = 2;
                                  break; 
                                                    
          default:                console.log('Not a special mode, command discarded !!');
                                  return;
       }
       // state and kind are mandatory parameters for special mode changes!       
       daikin.setACSpecialMode({"state":SpecialModeState, "kind":SpecialModeKind});
   });

}

// POST new Fan Rate settings to Airconditioner    
exports.daikinFanRateControl = function(fan_rate, ip_address, epp, options) {
...
// POST new Fan Rate settings to Airconditioner    
exports.daikinFanDirControl = function(fan_direction, ip_address, epp, options) {
...
exports.daikinTempControl = function(atemp, ip_address, epp, options) {
