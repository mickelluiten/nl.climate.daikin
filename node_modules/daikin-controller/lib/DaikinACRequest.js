...
/*jslint node: true */
/*jslint esversion: 6 */
//this is a modified version to support Airbase WiFi adapters used in some countries i.e. Australia
//parameter epp (endpointprefix) has been added
'use strict';
...
function DaikinACRequest(ip, epp, options) {
    this.ip = ip;
    this.epp = epp;
    this.logger = null;
    if (! options) {
...
DaikinACRequest.prototype.getCommonBasicInfo = function getCommonBasicInfo(callback) {
    this.getRequest('http://' + this.ip + this.epp + 'common/basic_info', function (data, response) {
...
DaikinACRequest.prototype.getCommonRemoteMethod = function getCommonRemoteMethod(callback) {
    this.getRequest('http://' + this.ip + this.epp + 'aircon/get_remote_method', function (data, response) {
...
DaikinACRequest.prototype.setCommonAdapterLED = function setCommonLED(values, callback) {
    ...
    this.postRequest('http://' + this.ip + this.epp + 'common/set_led', normalizedVals, function (data, response) {
        parseResponse(data, 'response', callback);
    });
};

DaikinACRequest.prototype.commonRebootAdapter = function rebootAdapter(callback) {
    this.postRequest('http://' + this.ip + this.epp + 'common/reboot', function (data, response) {
        parseResponse(data, 'response', callback);
    });
};

DaikinACRequest.prototype.getACModelInfo = function getACModelInfo(callback) {
    this.getRequest('http://' + this.ip + this.epp + 'aircon/get_model_info', function (data, response) {
...
DaikinACRequest.prototype.getACControlInfo = function getACControlInfo(callback) {
    this.getRequest('http://' + this.ip + this.epp + 'aircon/get_control_info', function (data, response) {
...
DaikinACRequest.prototype.setACControlInfo = function setACControlInfo(values, callback) {
    ...
    this.postRequest('http://' + this.ip + this.epp + 'aircon/set_control_info', normalizedVals, function (data, response) {
        parseResponse(data, 'response', callback);
    });
};

DaikinACRequest.prototype.getACSensorInfo = function getACSensorInfo(callback) {
    this.getRequest('http://' + this.ip + this.epp + 'aircon/get_sensor_info', function (data, response) {
...
DaikinACRequest.prototype.getACWeekPower = function getACWeekPower(callback) {
    this.getRequest('http://' + this.ip + this.epp + 'aircon/get_week_power', function (data, response) {
...
DaikinACRequest.prototype.getACYearPower = function getACYearPower(callback) {
    if (this.logger) this.logger('Call GET http://' + this.ip + this.epp + 'aircon/get_year_power');
    this.getRequest('http://' + this.ip + this.epp + 'aircon/get_year_power', function (data, response) {
...
DaikinACRequest.prototype.getACWeekPowerExtended = function getACWeekPowerExtended(callback) {
    if (this.logger) this.logger('Call GET http://' + this.ip + this.epp + 'aircon/get_week_power_ex');
    this.getRequest('http://' + this.ip + this.epp + 'aircon/get_week_power_ex', function (data, response) {
...
DaikinACRequest.prototype.getACYearPowerExtended = function getACYearPowerExtended(callback) {
    this.getRequest('http://' + this.ip + this.epp + 'aircon/get_year_power_ex', function (data, response) {
...
DaikinACRequest.prototype.setACSpecialMode = function setACSpecialMode(values, callback) {
    var normalizedVals;
    try {
        normalizedVals = this.normalizeValues(values, this.epp + 'aircon/set_special_mode');
    }
    catch (err) {
        if (callback) callback(err.message);
        return;
    ...
    if (normalizedVals.spmode_kind === '0') {
        ...
        this.postRequest('http://' + this.ip + this.epp + 'aircon/set_special_mode', vals, function (data, response) {
            parseResponse(data, 'response', callback);
        });
    }
    else {
        this.postRequest('http://' + this.ip + this.epp + 'aircon/set_special_mode', normalizedVals, function (data, response) {
            parseResponse(data, 'response', callback);
        });
    }
};
