...
DaikinACRequest.prototype.doGet = function doGet(url, parameters, callback) {
    ...
    //this.restClient.get(url, data, callback); // no error handling... app crashes... when airco not available...
    this.restClient.get(url, data, callback, function () {
    	// dummy action which is not executed...
        console.log('Request was successfull');
    }).on('error', function (err) {
    	console.log('Error, something went wrong on the request:', err.request.options);
    });
};
