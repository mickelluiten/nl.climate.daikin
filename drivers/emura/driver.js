...
class EmuraDriver extends Driver {
  onInit() {
    ...
    this._actionTargetTemp.registerRunListener((args, state) => {
      ...
      const ip_address = settings.emura_ip;
      ...
      const useGetToPost = settings.emura_useGetToPost;
      const adapter = settings.emura_adapter;
      let options = {};
...
//*** TRIGGER FLOWCARDS *******************************************************************************************
    ...
    //--- Temperature flowcards	
        ...
        /***  MODE CHANGE TRIGGERS ***/
		this._triggerAircoMode = new Homey.FlowCardTriggerDevice('mode_emura_changed').register();
		this._triggerAircoMode.registerRunListener((args, state) => {
...
//*** CONDITION FLOWCARDS *******************************************************************************************
        ...
        /***  MODE CHANGE CONDITIONS ***/
		this._conditionAircoMode = new Homey.FlowCardCondition('mode_emura_equals').register();
		this._conditionAircoMode.registerRunListener((args, state) => {
			let device = args.device;
...
//*** ACTION FLOWCARDS *******************************************************************************************
    ...
    //--- MODE CHANGE ACTIONS
		this._actionAircoMode = new Homey.FlowCardAction('change_emura_mode').register();
		this._actionAircoMode.registerRunListener((args, state) => {
			let device = args.device;           
            let settings = device.getSettings();   
