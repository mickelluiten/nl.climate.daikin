...
//VVVVVVVVVVVVV TO BE REMOVED !!! HERE IN SUPPORT OF FLOW CARD MIGRATION !!!! VVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVV
//*** TRIGGER FLOWCARDS *******************************************************************************************
          
    //--- Temperature flowcards	
		/*** TARGET TEMPERATURE TRIGGERS ***/        
        this._triggerTargetTemperatureMoreThan = new Homey.FlowCardTriggerDevice('change_comfora_target_temperature_more_than').register();
		this._triggerTargetTemperatureMoreThan.registerRunListener((args, state) => {
		...
		this._triggerTargetTemperatureLessThan = new Homey.FlowCardTriggerDevice('change_comfora_target_temperature_less_than').register();
		this._triggerTargetTemperatureLessThan.registerRunListener((args, state) => {
			let conditionMet = state.target_temperature < args.target_temperature_less;
			return Promise.resolve(conditionMet);
		});

		this._triggerTargetTemperatureBetween = new Homey.FlowCardTriggerDevice('change_comfora_target_temperature_between').register();
		this._triggerTargetTemperatureBetween.registerRunListener((args, state) => {
	    ...
	    /*** INSIDE TEMPERATURE TRIGGERS ***/
		this._triggerInsideTemperatureMoreThan = new Homey.FlowCardTriggerDevice('inside_comfora_temperature_more_than').register();
		this._triggerInsideTemperatureMoreThan.registerRunListener((args, state) => {
		...
		this._triggerInsideTemperatureLessThan = new Homey.FlowCardTriggerDevice('inside_comfora_temperature_less_than').register();
		this._triggerInsideTemperatureLessThan.registerRunListener((args, state) => {
			let conditionMet = state['measure_temperature.inside'] < args.inside_temperature_less;
			return Promise.resolve(conditionMet);
		});

		this._triggerInsideTemperatureBetween = new Homey.FlowCardTriggerDevice('inside_comfora_temperature_between').register();
		this._triggerInsideTemperatureBetween.registerRunListener((args, state) => {
		...
		/*** OUTSIDE TEMPERATURE TRIGGERS ***/
		this._triggerOutsideTemperatureMoreThan = new Homey.FlowCardTriggerDevice('outside_comfora_temperature_more_than').register();
		this._triggerOutsideTemperatureMoreThan.registerRunListener((args, state) => {
		...
		this._triggerOutsideTemperatureLessThan = new Homey.FlowCardTriggerDevice('outside_comfora_temperature_less_than').register();
		this._triggerOutsideTemperatureLessThan.registerRunListener((args, state) => {
			let conditionMet = state['measure_temperature.outside'] < args.ouside_temperature_less;
			return Promise.resolve(conditionMet);
		});

		this._triggerOutsideTemperatureBetween = new Homey.FlowCardTriggerDevice('outside_comfora_temperature_between').register();
		this._triggerOutsideTemperatureBetween.registerRunListener((args, state) => {
        ...
        /***  MODE CHANGE TRIGGERS ***/
		this._triggerAircoMode = new Homey.FlowCardTriggerDevice('mode_comfora_changed').register();
		this._triggerAircoMode.registerRunListener((args, state) => {
...
//*** CONDITION FLOWCARDS *******************************************************************************************
    	...
    	/*** TARGET TEMPERATURE CONDITIONS ***/
		this._conditionTargetTemperatureMoreThan = new Homey.FlowCardCondition('has_comfora_target_temperature_more_than').register();
		this._conditionTargetTemperatureMoreThan.registerRunListener((args, state) => {
		...
		this._conditionTargetTemperatureLessThan = new Homey.FlowCardCondition('has_comfora_target_temperature_less_than').register();
		this._conditionTargetTemperatureLessThan.registerRunListener((args, state) => {
			let device = args.device;
            let devicestate = device.getState();
		...
		this._conditionTargetTemperatureBetween = new Homey.FlowCardCondition('has_comfora_target_temperature_between').register();
		this._conditionTargetTemperatureBetween.registerRunListener((args, state) => {
			let device = args.device;
            let devicestate = device.getState();
		...
		/*** INSIDE TEMPERATURE CONDITIONS ***/
		this._conditionInsideTemperatureMoreThan = new Homey.FlowCardCondition('has_comfora_inside_temperature_more_than').register();
		this._conditionInsideTemperatureMoreThan.registerRunListener((args, state) => {
			let device = args.device;
            let devicestate = device.getState();
		...
		this._conditionInsideTemperatureLessThan = new Homey.FlowCardCondition('has_comfora_inside_temperature_less_than').register();
		this._conditionInsideTemperatureLessThan.registerRunListener((args, state) => {
			let device = args.device;
            let devicestate = device.getState();
		...
		this._conditionInsideTemperatureBetween = new Homey.FlowCardCondition('has_comfora_inside_temperature_between').register();
		this._conditionInsideTemperatureBetween.registerRunListener((args, state) => {
			let device = args.device;
            let devicestate = device.getState();
		...
		/*** OUTSIDE TEMPERATURE CONDITIONS ***/
		this._conditionOutsideTemperatureMoreThan = new Homey.FlowCardCondition('has_comfora_outside_temperature_more_than').register();
		this._conditionOutsideTemperatureMoreThan.registerRunListener((args, state) => {
			let device = args.device;
            let devicestate = device.getState();
		...
		this._conditionOutsideTemperatureLessThan = new Homey.FlowCardCondition('has_comfora_outside_temperature_less_than').register();
		this._conditionOutsideTemperatureLessThan.registerRunListener((args, state) => {
			let device = args.device;
            let devicestate = device.getState();
		...
		this._conditionOutsideTemperatureBetween = new Homey.FlowCardCondition('has_comfora_outside_temperature_between').register();
		this._conditionOutsideTemperatureBetween.registerRunListener((args, state) => {
			let device = args.device;
            let devicestate = device.getState();
        ...
        /***  MODE CHANGE CONDITIONS ***/
		this._conditionAircoMode = new Homey.FlowCardCondition('mode_comfora_equals').register();
		this._conditionAircoMode.registerRunListener((args, state) => {
			let device = args.device;
...
//*** ACTION FLOWCARDS *******************************************************************************************
    	...
    	/*** TARGET TEMPERATURE ACTION ***/ 
		this._actionTargetTemp = new Homey.FlowCardAction('change_comfora_target_temp').register();
		this._actionTargetTemp.registerRunListener((args, state) => {
			let device = args.device;           
            let settings = device.getSettings();   
    ...
    //--- MODE CHANGE ACTIONS
		this._actionAircoMode = new Homey.FlowCardAction('change_comfora_mode').register();
		this._actionAircoMode.registerRunListener((args, state) => {
			let device = args.device;           
            let settings = device.getSettings();   
    ...
    //--- FAN RATE ACTIONS
		this._actionFanRate = new Homey.FlowCardAction('change_comfora_fan_rate').register();
		this._actionFanRate.registerRunListener((args, state) => {
			let device = args.device;           
            let settings = device.getSettings();   
    ...
    //--- FAN DIRECTION ACTIONS
		this._actionFanDirection = new Homey.FlowCardAction('change_comfora_fan_direction').register();
		this._actionFanDirection.registerRunListener((args, state) => {
			let device = args.device;           
            let settings = device.getSettings();   
...
//^^^^^^^^^^^^^^^ TO BE REMOVED !!! HERE IN SUPPORT OF FLOW CARD MIGRATION !!!!  ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
